...
from face_auditor.lib_dataset.task_dataset import TaskDataset, ProbeDataset, ProbeDatasetSort
from face_auditor.lib_dataset.transform import NWays, KShots, LoadData, RemapLabels
from face_auditor.lib_model.relation_net.relation_net import RelationNet
...
class ExpClassMemInferMeta(ExpClassMemInfer):
    ...
    def save_results(self, upload_data: dict = {}):
        if self.args['is_use_image_similarity']:
