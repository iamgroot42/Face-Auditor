...
if __name__ == "__main__":
    ...
    root = os.path.join(config.RAW_DATA_PATH, "celeba")
    attr = "identity"
    attr_list = []
    ...
    # clean_dataset(os.path.join(root, 'img_align_celeba/'), os.path.join(root, 'identity_CelebA.txt'))
    # sort_dataset(os.path.join(root, 'identity_CelebA.txt'), os.path.join(root, 'celeba_num_imgs.txt'))
    # dataset = CelebA(root=root, transform=transform, is_download=False)
    # print(len(dataset))
